...
export const MENU_DATA: MenuCategory[] = [
  {
    title: "套餐",
    items: [
      { id: 'set-1', name: '板腱牛排+脆皮炸雞或炸魚套餐', weight: '7oz', price: 299, description: "附:①日湯②麵包③主餐④脆薯⑤飲料", customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2, componentChoice: { title: '炸物選擇', options: ['脆皮炸雞', '炸魚'] } }, isAvailable: true },
      { id: 'set-2', name: '板腱牛排+脆皮炸雞或炸魚套餐', weight: '10oz', price: 399, description: "附:①日湯②麵包③主餐④脆薯⑤飲料", customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2, componentChoice: { title: '炸物選擇', options: ['脆皮炸雞', '炸魚'] } }, isAvailable: true },
      { id: 'set-3', name: '板腱牛排+脆皮炸雞或炸魚套餐', weight: '14oz', price: 499, description: "附:①日湯②麵包③主餐④脆薯⑤飲料", customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2, componentChoice: { title: '炸物選擇', options: ['脆皮炸雞', '炸魚'] } }, isAvailable: true },
      { id: 'set-4', name: '上蓋牛排+脆皮炸雞或炸魚套餐', weight: '7oz', price: 299, description: "附:①日湯②麵包③主餐④脆薯⑤飲料", customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2, componentChoice: { title: '炸物選擇', options: ['脆皮炸雞', '炸魚'] } }, isAvailable: true },
      { id: 'set-5', name: '上蓋牛排+脆皮炸雞或炸魚套餐', weight: '10oz', price: 399, description: "附:①日湯②麵包③主餐④脆薯⑤飲料", customizations: { doneness: true, sauceChoice: true, drinkChoice: true, notes: true, saucesPerItem: 2, componentChoice: { title: '炸物選擇', options: ['脆皮炸雞', '炸魚'] } }, isAvailable: true },
  ...
  },
  {
    title: "簡餐",
    items: [
      { id: 'simple-meal-set', name: '簡餐套餐', price: 175, description: "套餐附:①日湯 ②主餐 ③脆薯 ④甜品 ⑤飲料", customizations: { 
        drinkChoice: true, 
        notes: true, 
        multiChoice: { 
          title: '主餐選擇', 
      ...
      { id: 'simple-meal-single', name: '簡餐單點', price: 75, description: "簡餐附(選二)→①日湯 ②脆薯 ③甜品 ④飲料", customizations: { 
        notes: true, 
        multiChoice: { 
          title: '主餐選擇', 
          options: ["黃金脆皮炸雞塊", "黃金泡菜脆皮雞塊吃到堡", "華夫蘋果沙拉雞塊吃到堡", "蛋沙拉脆皮雞塊吃到堡", "波士頓花生冰淇淋吃到堡", "溶岩巧克佐冰淇淋吃到堡"] 
  ...
  },
  {
    title: "炸物&漢堡",
    items: [
      { id: 'fried-chicken-single', name: '脆皮炸雞塊', price: 75, description: "單點", customizations: { notes: true }, isAvailable: true },
      { id: 'fried-chicken-gold-single', name: '黃金脆皮炸雞塊', price: 75, description: "單點", customizations: { notes: true }, isAvailable: true },
      { id: 'burger-kimchi-single', name: '黃金泡菜脆皮雞塊吃到堡', price: 80, description: "單點", customizations: { notes: true }, isAvailable: true },
      { id: 'burger-waffle-apple-single', name: '華夫蘋果沙拉雞塊吃到堡', price: 80, description: "單點", customizations: { notes: true }, isAvailable: true },
      { id: 'burger-egg-salad-single', name: '蛋沙拉脆皮雞塊吃到堡', price: 80, description: "單點", customizations: { notes: true }, isAvailable: true },
      { id: 'burger-peanut-icecream-single', name: '波士頓花生冰淇淋吃到堡', price: 80, description: "單點", customizations: { notes: true }, isAvailable: true },
      { id: 'burger-chocolate-icecream-single', name: '溶岩巧克佐冰淇淋吃到堡', price: 80, description: "單點", customizations: { notes: true }, isAvailable: true },
      { id: 'fried-chicken-set', name: '脆皮炸雞塊套餐', price: 175, description: "附:①日湯②主餐③脆薯④甜品⑤飲料", customizations: { drinkChoice: true, notes: true }, isAvailable: true },
      { id: 'fried-chicken-gold-set', name: '黃金脆皮炸雞塊套餐', price: 175, description: "附:①日湯②主餐③脆薯④甜品⑤飲料", customizations: { drinkChoice: true, notes: true }, isAvailable: true },
      { id: 'burger-kimchi-set', name: '黃金泡菜脆皮雞塊吃到堡套餐', price: 175, description: "附:①日湯②主餐③脆薯④甜品⑤飲料", customizations: { drinkChoice: true, notes: true }, isAvailable: true },
      { id: 'burger-waffle-apple-set', name: '華夫蘋果沙拉雞塊吃到堡套餐', price: 175, description: "附:①日湯②主餐③脆薯④甜品⑤飲料", customizations: { drinkChoice: true, notes: true }, isAvailable: true },
      { id: 'burger-egg-salad-set', name: '蛋沙拉脆皮雞塊吃到堡套餐', price: 175, description: "附:①日湯②主餐③脆薯④甜品⑤飲料", customizations: { drinkChoice: true, notes: true }, isAvailable: true },
      { id: 'burger-peanut-icecream-set', name: '波士頓花生冰淇淋吃到堡套餐', price: 175, description: "附:①日湯②主餐③脆薯④雞塊⑤飲料", customizations: { drinkChoice: true, notes: true }, isAvailable: true },
      { id: 'burger-chocolate-icecream-set', name: '溶岩巧克佐冰淇淋吃到堡套餐', price: 175, description: "附:①日湯②主餐③脆薯④雞塊⑤飲料", customizations: { drinkChoice: true, notes: true }, isAvailable: true },
    ]
  },
  {
    title: "涼麵",
    items: [
      { id: 'cold-noodle-single', name: '涼麵', price: 75, description: "單點。請選擇口味", customizations: { 
        multiChoice: { 
          title: '涼麵口味', 
      ...
      { id: 'cold-noodle-set', name: '涼麵套餐', price: 175, description: "附:①日湯②主餐③脆薯④甜品⑤飲料", customizations: { 
        multiChoice: { 
          title: '涼麵口味', 
          options: ["日式涼麵", "泰式涼麵", "沙茶涼麵", "蒜香涼麵", "金瓜涼麵", "巴薩米醋涼麵", "香葱涼麵", "凱撒涼麵", "橙汁涼麵", "黑胡椒涼麵", "台式涼麵", "BBQ涼麵"] 
        }, 
  ...
  },
  {
    title: "義大利麵",
    items: [
      { id: 'pasta-choice-single', name: '任選義麵 (簡餐)', price: 160, description: "簡餐附(選二)→①日湯 ②脆薯 ③甜品 ④飲料", customizations: { 
        pastaChoice: true, 
        notes: true, 
        sideChoice: { 
          title: '簡餐附餐 (請選二)', 
      ...
      { id: 'pasta-choice-set', name: '任選義麵 (套餐)', price: 220, description: "附:①日湯 ②主餐 ③甜品 ④麵包 ⑤飲料", customizations: { 
        pastaChoice: true, 
        drinkChoice: true, 
        notes: true 
      }, isAvailable: true },
  ...
  },
  {
    title: "甜品",
    items: [
      { id: 'dessert-choice-single', name: '任選甜品', price: 99, description: "A區、B區各任選一種。", customizations: { 
        dessertChoice: true, 
        notes: true 
      }, isAvailable: true },
      { id: 'dessert-choice-set', name: '任選甜品套餐', price: 200, description: "附:①日湯②主餐③脆薯④雞塊⑤飲料", customizations: { 
        dessertChoice: true, 
        drinkChoice: true, 
        notes: true 
      }, isAvailable: true },
